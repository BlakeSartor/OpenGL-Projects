...
void ArtRenderApp::DrawUsingOpenGL() {
    ...
    if (shader_style_ == 0) {
        ...
        //phong_shaderprog_.SetUniform("surfaceTex", surface_tex);
    ...
    if (shader_style_ == 2) {
        ...
        gouraud_shaderprog_.SetUniform("modelViewMatrix", model_view_matrix);
        gouraud_shaderprog_.SetUniform("normalMatrix", normal_matrix);
        gouraud_shaderprog_.SetUniform("projectionMatrix", proj_matrix_);
        ...
        gouraud_shaderprog_.SetUniform("lightPosition", light_in_view_space);
